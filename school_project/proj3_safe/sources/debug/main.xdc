...
#debug
#set_property PACKAGE_PIN U15 [get_ports {ld_curr[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ld_curr[0]}]
#set_property PACKAGE_PIN U14 [get_ports {ld_curr[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ld_curr[1]}]
#set_property PACKAGE_PIN V14 [get_ports {ld_curr[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ld_curr[2]}]
#set_property PACKAGE_PIN V13 [get_ports {ld_curr[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ld_curr[3]}]
#set_property PACKAGE_PIN V3 [get_ports {ld_curr[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ld_curr[4]}]
#set_property PACKAGE_PIN W3 [get_ports {ld_curr[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ld_curr[5]}]
#set_property PACKAGE_PIN U3 [get_ports {ld_curr[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ld_curr[6]}]